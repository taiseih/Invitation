...
$from = "taisei.hayashizaki@gmail.com";
...
?>
	...
	<head>
		...
		<style type="text/css">
			...
			.add-confirmTableTr:last-child {
				border-bottom: none;
			}

			.add-confirmTableHead {
				position: relative;
				width: 30%;
				background-color: #52c2d0;
				color: white;
